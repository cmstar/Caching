...
namespace cmstar.Caching.Reflection
{
    ...
    public static class ReflectionUtils
    {
        ...
        /// <summary>
        /// 获取Lambda表达式所指向的成员名称，成员可以是属性或域。
        /// </summary>
        /// <param name="memberAccessor">成员访问表达式。</param>
        /// <returns>成员名称。</returns>
        /// <exception cref="ArgumentNullException">当<paramref name="memberAccessor"/>为<c>null</c>。</exception>
        /// <exception cref="ArgumentException">
        /// 当<paramref name="memberAccessor"/>的<see cref="LambdaExpression.Body"/>不是属性访问。
        /// </exception>
